...
class OrderHelper(object):    
    ...
    def batchInsert(self, dataRows):
        ...
        for dataRow in dataRows:
            uuid = str(getUUID())
            params = {"v_id": uuid, "v_card_id": dataRow[3], "v_transaction_date":dataRow[1], "v_bookkeeping_date":dataRow[2], "v_transaction_desc" : dataRow[7], "v_balance_currency" : dataRow[6], "v_balance_money": dataRow[4], "v_card_type_id":1, "v_card_type_name":"中国建设银行购物卡", "v_consumption_type": dataRow[11], "v_consume_id": dataRow[13], "v_consume_name" : dataRow[12], "v_demoarea": dataRow[14], "v_recordid":recordID, "v_payment_type_id":dataRow[9]}
